...
function ExistRoom(props){
    ...
    return(
        ...
        <span id={props.id} onClick={props.glowSelectedRoom} className="text-center flex flex-col border-solid border-black rounded-lg h-full w-48 justify-center items-center">
            ...
            <div className="w-full">
                ...
                <svg onClick={props.deleteSelectedLines} xmlns="http://www.w3.org/2000/svg" className="h-full w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
